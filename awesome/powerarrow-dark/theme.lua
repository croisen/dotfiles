...
theme.volume                                    = wp({
    settings = function()
        if volume_now.muted == "muted" then
...
theme.volume.widget:buttons(my_table.join(
    awful.button({}, 4, function()
        theme.volume.incvol("1")
    end),
    awful.button({}, 5, function()
        theme.volume.decvol("1")
    end)
))
...
local cdir    = gears.filesystem.get_configuration_dir()
local arctdir = cdir .. "icons/Arc/"

local cpuld   = require("awesome-wm-widgets.cpu-widget.cpu-widget")
local netspd  = require("awesome-wm-widgets.net-speed-widget.net-speed")
    ...
    s.mybotwibox:setup {
        ...
        { -- Left widgets
            ...
            spotify({
                ...
                dim_opacity = 0.5,
                max_length = 80,
                play_icon = arctdir .. "actions/24/player_play.png",
                pause_icon = arctdir .. "actions/24/player_pause.png",
                timeout = 1,
                sp_bin = cdir .. "scripts/sp",
            }),
            arlr_ld,
            arlr_dl,
        },
