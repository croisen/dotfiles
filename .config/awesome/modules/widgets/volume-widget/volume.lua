...
-- https://github.com/streetturtle/modules/widgets/tree/master/volume-widget
...
local utils = require("modules/widgets/volume-widget/utils")
...
local widget_types = {
    icon_and_text = require("modules/widgets/volume-widget/widgets/icon-and-text-widget"),
    icon = require("modules/widgets/volume-widget/widgets/icon-widget"),
    arc = require("modules/widgets/volume-widget/widgets/arc-widget"),
    horizontal_bar = require("modules/widgets/volume-widget/widgets/horizontal-bar-widget"),
    vertical_bar = require("modules/widgets/volume-widget/widgets/vertical-bar-widget")
}
local volume = {}
