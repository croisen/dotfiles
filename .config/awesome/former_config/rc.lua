...
-- Custom widget setup
-- Streetturtle's widgets https://github.com/streetturtle/awesome-wm-widgets
...
-- lain stuff https://github.com/lcpz/lain/
...
globalkeys = gears.table.join(
	...
	awful.key({ modkey }, "Return", function () awful.spawn(terminal) end,
		{description = "open a terminal", group = "App Launcher"}),
	...
	awful.key({ modkey }, "p", function() menubar.show() end,
		{description = "show the menubar", group = "App Launcher"}),
	...
	awful.key({ }, "XF86AudioRaiseVolume", volume_control.up,
		{description = "raise volume", group = "Control"}),

	awful.key({ }, "XF86AudioLowerVolume", volume_control.down,
		{description = "decrease volume", group = "Sound Control"}),

	awful.key({ }, "XF86AudioMute", volume_control.toggle,
	...
	awful.key({ modkey }, "b",
		...
		{description = "run firefox", group = "Frequently Used Apps"}),

	awful.key({ modkey }, "e",
		function ()
			awful.util.spawn('thunar', false)
		end,
		{description = "run thunar file manager", group = "Frequently Used Apps"}),

	awful.key ({}, "Print",
		function ()
			awful.util.spawn('xfce4-screenshooter', false)
		end,
		{description = "take a screenshot", group = "Frequently Used Apps"}),

	awful.key ({ alt_key }, "m",
		function ()
			awful.util.spawn('audacious', false)
		end,
		{description = "open audacious my music player", group = "Frequently Used Apps"}),
	...
	awful.key ({ alt_key }, "b",
		...
		{description = "open bluetooth manager", group = "Frequently Used Apps"}),
	...
	awful.key ({ alt_key }, "c",
		...
		{descrtiption = "open calculator", group = "Frequently Used Apps"}),
	...
	awful.key ({ alt_key }, "r",
		...
		{descrtiption = "open a screen recorder", group = "Frequently Used Apps"})
)
